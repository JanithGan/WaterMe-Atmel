#ifndef ESP8266_H_FILE_H_
#define ESP8266_H_FILE_H_

#include "USART_RS232_H_file.h"			// Include USART header file
#include "../Variables.h"				// Include Variables header file
...
// ESP8266 Module Ultimate Setup
void ESP8266_Setup();														// Setup with Predefined Conditions
void ESP8266_Refresh();														// Refresh Connection
